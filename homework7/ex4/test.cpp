...
void test_float_cons()
{
	cout << "Testing float constructor" << endl;
	double d;
	cout << "Input a double for dollar" << endl;
	cin >> d;
	try{
		Money m(d);
		cout << m << endl;
...
void test_DKK()
{
	cout << "Testing currency function" << endl;
	double d;
	cout << "Input a double for DKK" << endl;
	cin >> d;
	try{
		Money m(Money::DKK,d);
		cout << m << endl;
		cout << m.convert_to(Money::DKK) << endl;
	}
	catch (Money::Invalid){
		cerr << "Error" << endl;
	}
